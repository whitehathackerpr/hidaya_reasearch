...
# ═══════════════════════════════════════════════════════════════════
# CELL: Feature Importance (TabPFN)
# ═══════════════════════════════════════════════════════════════════
md([
...
# ═══════════════════════════════════════════════════════════════════
# CELL: Feature Importance (Ensemble — Comparison)
# ═══════════════════════════════════════════════════════════════════
md([
    "### §9.1 — Ensemble Model Feature Importance (Gini, for comparison)\n",
    "\n",
    "For comparison, the tuned tree-ensemble model provides built-in Gini importance scores\n",
    "for the features that survived RFE elimination."
])
